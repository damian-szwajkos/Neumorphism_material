...
export function initSelects() {
    ...
    function updateButtonName() {
        ...
        let selectedOptions = Array.apply(null, $activeSelect[0].selectedOptions)
        let newButtonName = "";
    ...
    function clearDropdownAndBuildOptions() {
        ...
        buildOptions($activeSelectDropdown, Array.apply(null, $activeSelect[0].options));
